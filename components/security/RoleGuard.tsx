...
export default function RoleGuard() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
      ...
      {/* Tarjeta central */}
      <div className={`
        relative max-w-md w-[90%] bg-[#2D2D2D] border border-[#3B3A38] 
      ...
      `}>
        ...
        <div className={`h-1 w-full ${kickInfo.reason === 'role_changed' ? 'bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500' :
          kickInfo.reason === 'account_disabled' || kickInfo.reason === 'user_deleted' ? 'bg-gradient-to-r from-red-500 via-red-400 to-rose-500' :
            'bg-gradient-to-r from-blue-500 via-blue-400 to-[#71717a]'
          }`} />
        ...
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <div className={`
            ...
            bg-[#21201d] border border-[#4A4948]
            animate-pulse
          `}>
            {reasonConfig.icon}
          </div>
          ...
          {kickInfo.detail && (
            <div className="mb-4 bg-[#21201d] border border-[#3B3A38] rounded-xl px-4 py-2.5 inline-flex items-center gap-3">
          ...
          <div className="w-full space-y-3">
            <div className="w-full bg-[#1A1918] rounded-full h-1.5 overflow-hidden">
              <div
        ...
        <div className="bg-[#21201d]/50 border-t border-[#3B3A38] px-6 py-3 text-center">
