  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-transparent">
        ...
        <Navbar type="gastos" userName={userName} userRole={userRole} isAdmin={isAdmin} maxWidth="max-w-[95%]" />

        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-teal-50/10 pt-24">
          {children}
        </main>
      </div>
      <CopilotChat />
