    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333; border: 1px solid #e2e8f0; border-radius: 10px;">
          <h2 style="color: #FF7420; text-align: center;">¡Bienvenido al Equipo! 🚛</h2>
          ...
          <div style="background-color: #f8fafc; padding: 15px; border-left: 4px solid #FF7420; border-radius: 4px; margin: 20px 0;">
