  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .header { background-color: #0f172a; padding: 30px; text-align: center; border-bottom: 3px solid #FF7420; }
        .header h1 { color: #f8fafc; margin: 0; font-size: 24px; letter-spacing: 1px; }
        .header span { color: #FF7420; }
        ...
        .password-box { background-color: #0f172a; border: 1px solid #FF7420; border-radius: 8px; padding: 20px; text-align: center; margin-bottom: 30px; }
