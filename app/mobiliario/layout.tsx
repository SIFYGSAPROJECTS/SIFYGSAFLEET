...
export const metadata = {
  title: 'Inventario de Mobiliario | SIFYGSA',
  description: 'Gestión y control de inventario de mobiliario de oficina e infraestructura.',
};

export default async function MobiliarioLayout({
  children,
}: {
