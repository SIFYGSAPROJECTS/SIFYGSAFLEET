...
export default async function TelefoniaLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-transparent">
        ...
        <Navbar type="telefonia" userName={userName} userRole={userRole} isAdmin={isAdmin} maxWidth="max-w-[95%]" />

        <main className="flex-1 w-full bg-purple-50/10 pt-24">
          {children}
        </main>
      </div>
      <CopilotChat />
