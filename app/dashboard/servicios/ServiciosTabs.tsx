    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-5 mb-8">
        ...
        <div className="flex-1 flex flex-col items-start w-full text-left">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-white flex items-center gap-3">
            <Wrench className="text-[#01c38e]" size={32} /> Central de Servicios
          </h1>
        ...
        <div className="flex space-x-2 border-b border-[#132d46] min-w-max pb-px">
          ...
          <button
            ...
            className={`px-4 sm:px-6 py-3.5 font-bold text-sm sm:text-base flex items-center gap-2 border-b-2 transition-all whitespace-nowrap ${
              activeTab === 'nueva' ? 'border-[#01c38e] text-[#01c38e]' : 'border-transparent text-slate-500 hover:text-slate-300'
            }`}
          >
          ...
          >
            ...
            <span className={`ml-2 px-2 py-0.5 rounded-full text-xs ${activeTab === 'seguimiento' ? 'bg-cyan-500 text-black' : 'bg-[#132d46] text-slate-400'}`}>
              {activos.length}
            </span>
          </button>
      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {activeTab === 'seguimiento' && (
          <div className="bg-[#132d46]/50 p-1 rounded-xl">
