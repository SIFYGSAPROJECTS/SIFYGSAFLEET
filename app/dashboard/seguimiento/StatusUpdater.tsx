...
export default function StatusUpdater({ folio, estadoActual, lugarActual, fechaActual, horaActual, asesorActual, numeroAsesorActual, linkTallerActual, onUpdateTemporal }: any) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {estado === 'CITA' && (
        <div className="grid grid-cols-1 gap-2 p-3 bg-[#21201d]/50 rounded-lg border border-[#4A4948]">
          <input 
            className="bg-[#21201d] border border-[#4A4948] text-[10px] text-white p-1.5 rounded outline-none focus:border-cyan-500"
          ...
          <div className="flex gap-2">
            <input 
              className="w-1/2 bg-[#21201d] border border-[#4A4948] text-[10px] text-white p-1.5 rounded outline-none focus:border-cyan-500"
              placeholder="Fecha"
              value={fecha}
          ...
          <div className="flex items-center gap-2">
            ...
            <input 
              className="flex-1 bg-[#21201d] border border-[#4A4948] text-[10px] text-white p-1.5 rounded outline-none focus:border-cyan-500 placeholder:text-slate-600"
