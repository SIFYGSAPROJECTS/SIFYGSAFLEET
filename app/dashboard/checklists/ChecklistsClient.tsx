...
interface Props {
  vehiculos?: any[]; // Lo hacemos opcional por seguridad, pero debes pasárselo desde tu page.tsx del servidor
}

export default function ChecklistsPage({ vehiculos = [] }: Props) {
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="p-4 sm:p-8 max-w-5xl mx-auto">
        ...
        <div className="bg-slate-900 p-5 sm:p-8 rounded-2xl shadow-2xl border border-slate-800 mb-8 text-center" ref={dropdownRef}>
          ...
          <div className="flex flex-col sm:flex-row max-w-md mx-auto gap-3 relative">
            ...
            <div className="relative w-full">
              ...
              {showDropdown && filteredVehiculos.length > 0 && (
                <ul className="absolute z-10 w-full bg-slate-800 border border-slate-700 mt-2 rounded-lg shadow-2xl max-h-60 overflow-y-auto text-left">
        ...
        {/* ... TODO TU CÓDIGO DE ABAJO QUEDA EXACTAMENTE IGUAL ... */}
        {vehiculoActivo && (
