                      ...
                      {ticket.Evidencia ? (
                        <div className="flex items-center justify-center gap-2">
                          <button 
                            ...
                            className="inline-flex items-center gap-1.5 text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 px-3 py-1.5 rounded-md text-xs font-bold hover:bg-emerald-400/20 transition-all shadow-sm"
                          >
