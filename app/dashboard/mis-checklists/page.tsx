          ...
          <div className="w-full md:w-auto overflow-x-auto scrollbar-hide pb-3 pt-2 md:pt-0">
            <div className="flex w-full justify-start sm:justify-center md:justify-end min-w-max px-1">
              <div className="inline-flex items-center bg-[var(--bg-floating)] border border-[var(--border-cream)] rounded-full p-1.5 shadow-lg shrink-0 gap-1">
                ...
                <Link href="/dashboard/usuarios" className="px-4 py-1.5 text-xs font-bold rounded-full text-slate-500 hover:text-slate-700 hover:bg-[var(--bg-floating)] transition-colors flex items-center gap-2 whitespace-nowrap">
                  <User size={14} /> Usuarios
                </Link>

                <Link href="/dashboard/servicios" className="px-4 py-1.5 text-xs font-bold rounded-full text-slate-500 hover:text-slate-700 hover:bg-[var(--bg-floating)] transition-colors flex items-center gap-2 whitespace-nowrap">
          ...
          <div className="bg-[var(--bg-floating)] border-x border-b border-[var(--border-cream)] rounded-xl shadow-xl border-t-4 border-t-[#71717a] overflow-hidden">
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                <div className="bg-[var(--bg-floating)] border border-[var(--border-cream)] p-5 rounded-xl group hover:border-[#71717a]/30 transition-all">
              ...
              {unidadAsignada.checklists && unidadAsignada.checklists.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {unidadAsignada.checklists.map((check: any) => (
                    <div key={check.id} className="bg-[var(--bg-floating)] border border-[var(--border-cream)] rounded-xl p-6 hover:border-[#71717a]/50 transition-all group relative overflow-hidden flex flex-col justify-between h-full">
